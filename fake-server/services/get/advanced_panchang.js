...
module.exports = {
  path: "/panchang_api/advanced_panchang",
  template: {
    day: "Wednesday",
    sunrise: "7:3:17",
    sunset: "18:43:38",
    ...
    tithi: {
      details: {
        tithi_number: function(params, query) { return parseInt(query.day, 10) },
      ...
      end_time: {
        hour: generator.random(24),
        minute: generator.random(60),
        second: generator.random(60)
      }
    },
    nakshatra: {
      details: {
    ...
    vikram_samvat: function(params, query) {
      return parseInt(query.year, 10) + 52;
    },
    shaka_samvat: function(params, query) {
      return parseInt(query.year, 10) - 83;
    },
